          ...
          <div className='space-y-1 flex-1 min-w-0'>
            <div className='flex items-center space-x-2'>
              ...
              {communication.status === "SCHEDULED" && (
                <Badge
                  variant='outline'
                  className='bg-orange-100 text-orange-700 border-orange-300 dark:bg-orange-950/50 dark:text-orange-400 dark:border-orange-700'
                >
              ...
              {communication.status === "SENT" && (
                <Badge
                  variant='outline'
                  className='bg-green-100 text-green-700 border-green-300 dark:bg-green-950/50 dark:text-green-400 dark:border-green-700'
                >
      ...
      <CardContent className='space-y-4'>
        ...
        <div className='flex items-center justify-between text-sm'>
          ...
          <div className='text-right'>
            {communication.status === "SCHEDULED" ? (
              <div className='text-orange-600 font-medium'>Ready to send</div>
            ) : communication.status === "SENT" ? (
              <>
        ...
        <div className='space-y-2'>
          {communication.status === "SCHEDULED" &&
            communication.scheduledAt && (
              <div className='bg-orange-50 border border-orange-200 rounded-lg p-3 dark:bg-orange-950/30 dark:border-orange-800'>
                ...
                <div className='text-orange-700 font-semibold text-lg mt-1 dark:text-orange-300'>
          ...
          {communication.status === "SENT" && communication.sentAt && (
            <div className='bg-green-50 border border-green-200 rounded-lg p-3 dark:bg-green-950/30 dark:border-green-800'>
              <div className='flex items-center space-x-2 text-green-800 dark:text-green-400'>
                <CheckCircle className='h-4 w-4' />
                <span className='font-medium'>Sent on:</span>
              </div>
              <div className='text-green-700 font-semibold mt-1 dark:text-green-300'>
        ...
        {communication.createdBy && (
          <div className='flex items-center space-x-2 text-sm text-gray-600'>
            ...
            <span>
              By {communication.createdBy.firstName}{" "}
              {communication.createdBy.lastName}
            </span>
          </div>
        )}
